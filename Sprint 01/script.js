...
//==============================================================================
// botões 
document.querySelector("#botao_anterior").addEventListener("click", function () {
//(seleção do objeto        +    aguardar até que ele seja clicado)  
  
  var el = document.querySelector("#botao_anterior");
...
document.querySelector("#botao_proximo").addEventListener("click", function () {
//(seleção do objeto + aguardar até que ele seja clicado)     
  
  var el = document.querySelector("#botao_proximo");
...
var counter=0;
function start() {
  var button = document.getElementById("botao_proximo"); // trigger para dar inicio ao contador
}; // começar 
...
//=============================================
// Botao avançar '>'   
document.querySelector("#botao_proximo").addEventListener("click", (e)=>{ // seleção do objeto e aguardar o click
console.log("botao_proximo")   
...
//=======================================================================
// Button retroceder "<" 
document.querySelector("#botao_anterior").addEventListener("click", (e)=>{
    console.log("botao_anterior")   
